**[Versión en Castellano](#carta-abierta-a-las-administraciones-públicas-catalanas-y-españolas)**
...
amb la mateixa tecnologia](https://www.lavanguardia.com/cribeo/estilo-de-vida/20200324/4882165145/decenas-voluntarios-impresoras-3d-estan-creando-protectores-ayudar-sanitarios-asturias-coronavirus.html) o el [treball de modelització epidemiològica dels nostres investigadors](http://diaridigital.urv.cat/un-model-matematic-prediu-el-risc-de-nous-contagis-per-coronavirus-a-espanya/).
...
2. En cas que no existeixi, es desenvolupi un sistema de recollida i validació de dades sobre l'epidèmia que s'integri eficaçment i de manera no-intrusiva en els protocols d'actuació dels professionals sanitaris, a fi i efecte de garantir-ne la qualitat i el nivell de detall sense torbar el desenvolupament de la seva tasca principal.
...
* Nombre de tests administrats i el seu resultat, segmentats per dia, edat, sexe, comorbiditats, i població (o codi postal), així com pel tipus de test (PCR o altre)
...
## Apèndix II: Especificacions d’una aplicació centralitzada per la recollida, agregació i publicació de dades sobre la incidència de l’epidèmia
...
Creemos que el **talento innovador** y la **confianza** son dos piedras angulares para afrontar con éxito el reto sanitario inmediato, así como los retos sociales y económicos que aparecerán a medio y largo plazo.

El **talento innovador** de nuestro país es un activo incalculable para encontrar soluciones imaginativas y técnicamente avanzadas a los problemas que iremos afrontando en el ámbito de la salud pública, económico y social. Algunos ejemplos del mismo son la [fabricación de respiradores mediante diseños libres para impresoras 3D impulsada por empresas locales](https://www.ara.cat/economia/coronavirus-covid-19-respirador-impressio-3d_0_2421357959.html), la [manufactura de material de protección sanitario
con la misma tecnología](https://www.lavanguardia.com/cribeo/estilo-de-vida/20200324/4882165145/decenas-voluntarios-impresoras-3d-estan-creando-protectores-ayudar-sanitarios-asturias-coronavirus.html) o el [trabajo de modelización epidemiológica de nuestros investigadores](http://diaridigital.urv.cat/un-model-matematic-prediu-el-risc-de-nous-contagis-per-coronavirus-a-espanya/).

Por otra parte, la **confianza** mutua entre las instituciones y la ciudadanía es y será fundamental para entender, respetar y colaborar con las decisiones que, sin duda, hará falta tomar. 

Creemos firmemente que, para responder a esta crisis, las administraciones públicas tienen **el deber y la oportunidad de potenciar y desarrollar estos dos aspectos**, y pedimos que:

1. Se publiquen diariamente los datos epidemiológicos en los portales de datos abiertos de la administración, a un nivel de detalle adecuado para asegurar su explotación estadística siempre garantizando la privacidad de los ciudadanos, y en un formato explotable por informática. Estados como [Corea del Sur](https://coronamap.site/), [Alemania](https://npgeo-corona-npgeo-de.hub.arcgis.com/), algunos estados de [EEUU](https://covidtracking.com/) o [Italia](https://github.com/pcm-dpc/COVID-19) están apostando claramente por la recogida y publicación de datos detallados de manera periódica, lo que facilita la innovación y promueve la confianza entre la ciudadanía. 

2. Caso de no existir, se desarrolle un sistema de recogida y validación de datos sobre la epidemia que se integre eficazmente y de manera no-intrusiva en los protocolos de actuación de los profesionales sanitarios, a fin de garantizar su calidad y el nivel de detalle sin perturbar el desarrollo de su tarea principal.

3. Caso de no existir, se desarrolle un sistema automático de agregación, ofuscación y difusión de los datos recogidos en los puntos de actuación (hospitales, CAPs, teléfonos de emergencia, aplicaciones móviles) en un formato adecuado que permita su tratamiento informático.
...
Pedimos que se comience a recoger y publicar, de forma periódica, en la medida de las posibilidades y técnicas actuales, los datos siguientes:

* Número de tests administrados y su resultado, segmentados por día, edad, sexo, comorbilidades y población (o código postal), así como por el tipo de test (PCR u otro)
* Número de síntomas reportados, segmentados por día, edad, sexo, comorbilidades y población (o código postal)
* Número de ingresos hospitalarios, segmentados por día, edad, sexo, comorbilidades, por centro y por severidad
* Número de altas hospitalarias, segmentadas por día, edad, sexo, comorbilidades, por centro y por severidad
* Número de defunciones, segmentadas por día, edad, sexo, comorbilidades, por centro y por causa de defunción
* Número de llamadas a los números de emergencia, segmentado por día y por localidad
* Ocupación del transporte público en los grandes núcleos urbanos, segmentada por servicio y día

Para garantizar el derecho a la privacidad del individuo, habrá que establecer criterios de ofuscación allá donde el número de observaciones en un segmento dado de sexo, género y localidad fuese lo suficientemente bajo como para identificar el individuo.
